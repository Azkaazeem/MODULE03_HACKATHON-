...
export const Sidebar = () => (
  <aside className="glass-card hidden w-72 shrink-0 rounded-[30px] p-5 xl:block">
    <div className="mb-8 rounded-[24px] bg-gradient-to-br from-violet-500/20 to-blue-500/20 p-5">
